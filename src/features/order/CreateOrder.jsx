      ...
      <Form method="POST">
        ...
        <div className="mb-5 flex flex-col gap-2 sm:flex-row sm:items-center">
          ...
          <div className="grow">
            ...
            {formErrors?.phone && (
              <p className="mt-2 rounded-full bg-red-700 p-2 text-xs text-red-700">
                {formErrors.phone}
              </p>
            )}
          </div>
        ...
        <div className="b-5 relative flex flex-col gap-2 sm:flex-row sm:items-center">
        ...
        <div>
          ...
          <input type="hidden" name="position" value={position.longitude && position.latitude ?`${position.latitude}, ${position.longitude}` : 0} />
